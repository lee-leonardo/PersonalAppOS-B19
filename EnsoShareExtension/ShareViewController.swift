...
//	var ensoShareExtensionContext : NSExtensionContext?
//	var shareInputData : NSArray?
//	var imageData = NSData()
//	var haikuText : NSString?
//
//	override func loadView() {
//		super.loadView()
//		
//		self.ensoShareExtensionContext = self.extensionContext
//		self.shareInputData = self.ensoShareExtensionContext?.inputItems
//		
//	}
...
//        self.extensionContext.completeRequestReturningItems(nil, completionHandler: nil)
    ...
    override func configurationItems() -> [AnyObject]! {
		...
		var twitter = SLComposeSheetConfigurationItem()
		twitter.title = "Twitter"
		var pinterest = SLComposeSheetConfigurationItem()
		pinterest.title = "Pinterest"
		
		var items : [SLComposeSheetConfigurationItem] = [twitter, pinterest]
